...
FMOD::Sound* click, * escDown, * escUp, * scroll, *menuOpen, *menuClose, *menuClick;
...
void initFmod() {
	...
	ssystem->createSound("res//sound//menu_open.wav", FMOD_DEFAULT, 0, &menuOpen);
	ssystem->createSound("res//sound//menu_close.wav", FMOD_DEFAULT, 0, &menuClose);
	ssystem->createSound("res//sound//menu_click.wav", FMOD_DEFAULT, 0, &menuClick);
